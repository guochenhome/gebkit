...
package com.e_young.gebkit2.views;
...
import com.e_young.gebkit2.common.CommonWebChromeClient;
import com.e_young.gebkit2.common.CommonWebViewClient;
import com.e_young.gebkit2.env.Env;
...
public class SimpleWebPage extends RelativeLayout implements CommonWebViewClient.DoPageFinishedLiseter {
    ...
    public void init() {
        ...
        LayoutParams rootView = new LayoutParams(ViewGroup.LayoutParams.FILL_PARENT, ViewGroup.LayoutParams.FILL_PARENT);
        // 将WebView加到布局中
